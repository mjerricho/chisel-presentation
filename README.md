...
```sh
git clone git@github.com:mjerricho/chisel-presentation.git
cd chisel-presentation
```
...
#### Commit your changes
```sh
git commit -m 'Starting chisel-presentation'
